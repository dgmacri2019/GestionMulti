...
namespace LoginProduccion
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://wsaa.afip.gov.ar/ws/services/LoginCms", ConfigurationName="LoginProduccion.LoginCMS")]
    public interface LoginCMS
    {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(LoginProduccion.LoginFault), Action="", Name="fault")]
        LoginProduccion.loginCmsResponse loginCms(LoginProduccion.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<LoginProduccion.loginCmsResponse> loginCmsAsync(LoginProduccion.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public interface LoginCMSChannel : LoginProduccion.LoginCMS, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<LoginProduccion.LoginCMS>, LoginProduccion.LoginCMS
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        LoginProduccion.loginCmsResponse LoginProduccion.LoginCMS.loginCms(LoginProduccion.loginCmsRequest request)
        {
        ...
        {
            LoginProduccion.loginCmsRequest inValue = new LoginProduccion.loginCmsRequest();
            inValue.in0 = in0;
            LoginProduccion.loginCmsResponse retVal = ((LoginProduccion.LoginCMS)(this)).loginCms(inValue);
            return retVal.loginCmsReturn;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<LoginProduccion.loginCmsResponse> LoginProduccion.LoginCMS.loginCmsAsync(LoginProduccion.loginCmsRequest request)
        {
            return base.Channel.loginCmsAsync(request);
        }
        
        public System.Threading.Tasks.Task<LoginProduccion.loginCmsResponse> loginCmsAsync(string in0)
        {
            LoginProduccion.loginCmsRequest inValue = new LoginProduccion.loginCmsRequest();
            inValue.in0 = in0;
            return ((LoginProduccion.LoginCMS)(this)).loginCmsAsync(inValue);
        }
