...
namespace LoginHomologacion
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://wsaahomo.afip.gov.ar/ws/services/LoginCms", ConfigurationName="LoginHomologacion.LoginCMS")]
    public interface LoginCMS
    {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(LoginHomologacion.LoginFault), Action="", Name="fault")]
        LoginHomologacion.loginCmsResponse loginCms(LoginHomologacion.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<LoginHomologacion.loginCmsResponse> loginCmsAsync(LoginHomologacion.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public interface LoginCMSChannel : LoginHomologacion.LoginCMS, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<LoginHomologacion.LoginCMS>, LoginHomologacion.LoginCMS
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        LoginHomologacion.loginCmsResponse LoginHomologacion.LoginCMS.loginCms(LoginHomologacion.loginCmsRequest request)
        {
        ...
        {
            LoginHomologacion.loginCmsRequest inValue = new LoginHomologacion.loginCmsRequest();
            inValue.in0 = in0;
            LoginHomologacion.loginCmsResponse retVal = ((LoginHomologacion.LoginCMS)(this)).loginCms(inValue);
            return retVal.loginCmsReturn;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<LoginHomologacion.loginCmsResponse> LoginHomologacion.LoginCMS.loginCmsAsync(LoginHomologacion.loginCmsRequest request)
        {
            return base.Channel.loginCmsAsync(request);
        }
        
        public System.Threading.Tasks.Task<LoginHomologacion.loginCmsResponse> loginCmsAsync(string in0)
        {
            LoginHomologacion.loginCmsRequest inValue = new LoginHomologacion.loginCmsRequest();
            inValue.in0 = in0;
            return ((LoginHomologacion.LoginCMS)(this)).loginCmsAsync(inValue);
        }
