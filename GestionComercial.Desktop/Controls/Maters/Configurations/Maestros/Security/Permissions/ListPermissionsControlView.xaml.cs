...
namespace GestionComercial.Desktop.Controls.Maters.Configurations.Maestros.Security.Permissions
{
    /// <summary>
    /// Lógica de interacción para ListPermissionsControlView.xaml
    /// </summary>
    public partial class ListPermissionsControlView : UserControl
    {
        private readonly PermissionsApiService _apiService;
        private readonly PermissionListViewModel _viewModel;

        public event Action PermisoActualizado;

        public ListPermissionsControlView()
        {
            InitializeComponent();
        ...
        {
            PermisoActualizado?.Invoke(); // para notificar a la vista principal
        }
